...
if(NOT DEFINED MKL_Shared_FOUND)
...
# On macOS MKL only works with included Intel OpenMP
if(APPLE)
    set(MKL_THREAD_LAYER "Intel OpenMP")
elseif(UNIX)
    # To avoid RTL mismatch on Linux use GNU OpenMP when compiler is GNU
...
find_package_handle_standard_args(MKL_Shared
  FAIL_MESSAGE "Could NOT find MKL: If you know you have MKL source mklvars.sh"
...
endif(NOT DEFINED MKL_Shared_FOUND)
